                        ...
                        <div class="profile-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col ms-md-n2 profile-user-info">
                                    ...
                                    <div class="user-Location"><i class="fas fa-user"></i> &ensp;&ensp;<?php echo "<b>Grade</b> " . $row['grade'];?></div>
                                    <div class="about-text"><i class="fas fa-phone"></i>&ensp;&ensp;<?php echo $row['phone_no'];?></div>
                                </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <p class="col-sm-9"><?php echo $row['phone_no'];?></p>
                                                </div>
                                                <div class="row">
                                                    <p class="col-sm-3 text-muted text-sm-end mb-0">Grade</p>
                                                    &ensp;<?php echo $row['grade'];?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-10 col-lg-6">
                                                <form method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Grade</label>
                                                        <input type="text" 
                                                        value="<?php echo $row['grade'];?>"name="grade" 
