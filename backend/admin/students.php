                                ...
                                <div class="page-header">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto text-end float-end ms-auto download-grp">
                                            ...
                                            <a href="../export_student.php" class="btn btn-outline-primary me-2"><i class="fas fa-download"></i> Download</a>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <div class="actions ">
                                                        ...
                                                        <a href="edit-student.php?update='?><?php echo $row['id'];?><?php echo'" class="btn btn-sm bg-danger-light">
