...
<?php include "model/_addexam.php"; 
                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-12">
                            <div class="page-sub-header">
                                ...
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="view_classes.php">Exam</a></li>
                        ...
                        <div class="card comman-shadow">
                            <div class="card-body">
                                <form method="post">
                                    <div class="row">
                                        <div class="col-12">
                                            <h5 class="form-title student-info">Exam Information <span><a href="javascript:;"><i class="feather-more-vertical"></i></a></span></h5>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="student-submit">
                                                <button type="submit" name="btn" class="btn btn-primary">Add Exam</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
