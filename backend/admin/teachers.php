                                ...
                                <div class="page-header">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto text-end float-end ms-auto download-grp">
                                            ...
                                            <a href="../export_teacher.php" class="btn btn-outline-primary me-2"><i class="fas fa-download"></i> Download</a>
                                        ...
                                        <tr>
                                                ...
                                                <td class="text-end">
                                                    <div class="actions ">
                                                        ...
                                                        <a href="edit-teacher.php?update='?><?php echo $row['id'];?><?php echo'" class="btn btn-sm bg-danger-light">
