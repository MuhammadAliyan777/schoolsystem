                                ...
                                <div class="table-responsive">
                                    <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
                                        ...
                                        <tr>
                                                ...
                                                <td class="text-end">
                                                    <div class="actions ">
                                                    <a href="school_list.php?delete='?><?php echo $row['id'];?><?php echo'" class="btn btn-sm bg-danger-light">
                                                    <i class="feather-delete"></i>
                                                    </a>
                                                       
                                                        <a href="edit-school.php?update='?><?php echo $row['id'];?><?php echo'" class="btn btn-sm bg-danger-light">
