                            ...
                            <div class="card-body">
                                ...
                                <div class="page-header">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <h3 class="page-title">Exams Schedule</h3>
                                        </div>
                                        <div class="col-auto text-end float-end ms-auto download-grp">
                                            ...
                                            <a href="../export_exam.php" class="btn btn-outline-primary me-2"><i class="fas fa-download"></i> Download</a>
                                ...
                                <div class="table-responsive">
                                    <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <?php include "model/_viewexam.php"; ?>
                                                ...
                                                <td class="text-end">
                                                <div class="actions ">
                                                <a href="_viewexam.php?delete='?><?php echo $row['id'];?><?php echo'" class="btn btn-sm bg-danger-light">
                                                <i class="feather-delete"></i>
                                                </a>
                                                   
                                                    <a href="grant-result.php?update='?><?php echo $row['id'];?><?php echo'" class="btn btn-sm bg-danger-light">
