...
<?php include "model/_update_classes.php";?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Preskool - Edit Classes</title>
                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-12">
                            <div class="page-sub-header">
                                <h3 class="page-title">Edit Classes</h3>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="students.php">Classes</a></li>
                        ...
                        <div class="card comman-shadow">
                            <div class="card-body">
                                <form method="post">
                                    <div class="row">
                                        <div class="col-12">
                                            <h5 class="form-title student-info">Classes Information <span><a href="javascript:;"><i class="feather-more-vertical"></i></a></span></h5>
                                        </div>
                                            ...
                                            <div class="form-group local-forms">
                                                ...
                                                <select required name="teacher_name" class="form-control select">
                                                    ...
                                                    while ($row2 = mysqli_fetch_assoc($res2)) {
                                                        echo '<option selected value = "'.$row2['name'].'">'.$row2['name'].'</option>';
                                                    }
                                                    ?>
                                                </select>
                                            </div>
