...
$(document).ready(function () {
        ...
        //     var options = {
        //         // Rest of your options for the line chart
        //     };

        //     // Fetch teachers data using PHP from MySQL database
        //     $.ajax({
        //         url: 'data.php', // Replace with your PHP script to fetch data
        //         method: 'GET',
        //         dataType: 'json',
        //         success: function (data) {
        //             options.series = [
        //                 { name: "Teachers", color: "#3D5EE1", data: data },
        //             ];
        ...
        //     var options = {
        //         // Rest of your options for the area chart
        //     };

        //     // Fetch students data using PHP from MySQL database
        //     $.ajax({
        //         url: 'data2.php', // Replace with your PHP script to fetch data
        //         method: 'GET',
        //         dataType: 'json',
        //         success: function (data) {
        //             options.series = [
        //                 { name: "Students", color: "#70C4CF", data: data },
        //             ];
